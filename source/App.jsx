...
const SIDEBAR_GROUPS = [
  ...
  { label: 'Manage', items: ['Companies / Clients', 'Assets & Renewals', 'Licenses', 'Contracts', 'Documents'] },
...
function AssetsRenewalsScreen(){
  const rows = [
    ['Dell Support Contract','Contract','Dell','May 26, 2026','12 days','$42,800','Unassigned','Critical','Assign owner'],
    ['Microsoft 365 Renewal','License','Microsoft','Jun 1, 2026','18 days','$31,200','Ana Ruiz','High','Prepare renewal'],
    ['Fortinet Warranty','Warranty','Fortinet','Jun 7, 2026','24 days','$18,600','Luis Mora','High','Request quote'],
    ['SSL Wildcard Certificate','Certificate','DigiCert','May 23, 2026','9 days','$3,200','Unassigned','Critical','Prepare renewal'],
    ['Adobe Creative Cloud','SaaS','Adobe','Jun 11, 2026','28 days','$9,800','Carlos Vega','Medium','Review usage'],
